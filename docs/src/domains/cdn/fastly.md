...
Make sure you have a [custom domain](../steps/_index.md) set up and that your CDN points to your [project target](../../domains/steps/_index.md#2-get-the-target-for-your-project)
for the [DNS challenge to succeed](../troubleshoot.md#ownership-verification).
